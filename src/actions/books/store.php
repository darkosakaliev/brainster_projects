...
$sql = "INSERT INTO books (title, author_id, date_of_issue, number_of_pages, cover, category_id, description) VALUES (:title, :author_id, :date_of_issue, :number_of_pages, :cover, :category_id, :description)";
...
try {
    if ($stmt->execute($data)) {
        $_SESSION['msg'] = ['status' => 1, 'text' => 'You have added a book successfully!'];
