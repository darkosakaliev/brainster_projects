    ...
    <form action="{{ route('projects.store') }}" method="POST">
        ...
        <div class="flex flex-col lg:flex-row p-12 overflow-auto bg-img custom-lightgray">
                ...
                <div class="flex flex-col mt-12">
                    <div class="md:w-6/12">
                        <x-input id="name" class="block w-full p-0 focus:outline-none" type="name" name="name"
                            autofocus placeholder="Name of Project" />
                        @error('name')
            ...
            <div class="basis-2/4 mt-12 md:mt-0">
                ...
                <div class="custom-orange text-xs mt-6 text-right font-semibold">Please select no more than 4 options</div>
                <div class="flex justify-end mt-20">
                    <button class="custom-bg-green py-3 px-24 rounded-lg text-white" type="submit">CREATE</button>
                </div>
            </div>
        </div>
    </form>
